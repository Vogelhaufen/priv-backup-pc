...
#set before reg so the launcher doesn't die
#
export DISPLAY=
...
export LAUNCH_LOG="$WINEPREFIX/sc_launch.log"
...
#exec "$wine_path"/wine "C:\\Program Files\\Roberts Space Industries\\RSI Launcher\\RSI Launcher.exe" --disable-gpu --in-process-gpu
